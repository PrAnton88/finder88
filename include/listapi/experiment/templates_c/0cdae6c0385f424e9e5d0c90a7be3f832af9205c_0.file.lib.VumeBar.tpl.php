<?php
/* Smarty version 3.1.36, created on 2021-07-15 13:06:43
  from 'C:\Users\oto016\singleProjects\modx-info\core\Smarty\fromapi\lib.VumeBar.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_60f016c3e18b40_68138746',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0cdae6c0385f424e9e5d0c90a7be3f832af9205c' => 
    array (
      0 => 'C:\\Users\\oto016\\singleProjects\\modx-info\\core\\Smarty\\fromapi\\lib.VumeBar.tpl',
      1 => 1626346827,
      2 => 'file',
    ),
  ),
...
function content_60f016c3e18b40_68138746 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
...
const fBoldNode = function(text, cl){
	...
	let textNode = new oCr("text",cl);
	textNode = textNode.cont;
...
const getCont = function(cl){
	return new oCr("div", "p5 posRel "+cl).cont;
...
const getCheckbox = function(nid,hand,cl){
	...
	let ch = new oCr("input",(cl?cl:"")).cont;
	ch.type = "checkbox";
...
const shareEditTest = function(listQuery,currentlyTest,parentCurrentlyTest,yourListSavedQueryAsLink,cont,getBtnFreeLinkQuery,updateThemes,contCreate,getBtnSetCategory,updatePrivateField,updateRndField,getIconEditQuery,getBtnDelQuery,pushQueryTest,funcBack,funcInit,deliveryGrant,demoAccount){
	...
	*/
	...
	function getElementCheckedPropertyForUpdate(nameProp,nameField,funcUpdate){
		let checkEl = new oCr("input").cont;
	...
	if(demoAccount){
		setPrivateCheck = new oCr("input").cont;
