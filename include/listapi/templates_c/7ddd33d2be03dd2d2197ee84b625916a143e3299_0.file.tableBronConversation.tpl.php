...
function content_60f5890811e127_71844207 (Smarty_Internal_Template $_smarty_tpl) {
?> 
<?php echo '<script'; ?>
>
/* лищь бы что бы было */
...
(function(){
	...
	/* добавим в listRecords.get() ссылки на tr */
	
	let i = 0;
	let flagTableBronConversation = document.body.querySelectorAll('tbody.flagTableBronConversation tr');
	
	if(flagTableBronConversation){
		flagTableBronConversation = Array.from(flagTableBronConversation);
	}
	
	
	listRecords.get().map(item => {
		
		item.tr = flagTableBronConversation[i];
		i++;
	});
...
<?php $_smarty_tpl->_assignInScope('splDate', 555);?>
...
<?php if (count($_smarty_tpl->tpl_vars['messages']->value) > 0) {?>
	<table class="sAdmT tCenter w100 fs12 mB3" cellpadding="1" cellspacing="0">
		...
		<tbody class="flagTableBronConversation">
			<?php
...
-<?php echo $_smarty_tpl->tpl_vars['splDate']->value[0];?>
						...
						<?php if ($_smarty_tpl->tpl_vars['admin']->value || ($_smarty_tpl->tpl_vars['user']->value['uid'] == $_smarty_tpl->tpl_vars['message']->value['userId'])) {?>
							<td class="hdtbl p6 d-none d-sm-none d-md-none d-lg-table-cell">
								<span class="aUnderline crPoint" onclick="oIniPageBronСonversation.formEditRecord(<?php echo $_smarty_tpl->tpl_vars['message']->value['id'];?>
);">
							...
							<td class="hdtbl p6 d-none d-sm-none d-md-none d-lg-table-cell">
								...
								<span onclick="oIniPageBronСonversation.itemRemove(<?php echo $_smarty_tpl->tpl_vars['message']->value['id'];?>
,event);">
