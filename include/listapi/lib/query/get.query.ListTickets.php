<?php
	...
	function getQueryToGetTickets(){
    	...
    	cabAssd.name 'room', dpt.id as ndept, dpt.name as dept, c.int_phone 'inp', c.ext_phone 'exp', deptAssd.name as deptAssd 
    	FROM request as a
	...
	function getQueryToGetTicket(){
		...
		concat_ws(' ', b.last_name, b.first_name, b.patronymic) 'req', concat_ws(' ', b.last_name, b.first_name) as 'assdShort',
	...
	$queryCheckDispatchRequest = "SELECT rule FROM role WHERE (rule LIKE '%,6%') ";
?>