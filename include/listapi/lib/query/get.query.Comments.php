<?php
	...
	$queryGetComment = "Select c.*, UNIX_TIMESTAMP(c.date_reg) as date_reg, concat_ws(' ', u.last_name, u.first_name, u.patronymic) 'fio', i.image as avatar, i.path as avatarPath From `comments` as c  LEFT JOIN `users` as u ON u.role = c.user_link LEFT JOIN images_context as ic ON ic.ncontext = u.id 
